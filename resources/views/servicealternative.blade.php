                        ...
                        <div class="row">
                            ...
                            <div class="col-lg-3 col-md-4 col-sm-6">
                                <div class="card p-2 h-100" style="width: 100%; height: 100%;">
                                    <div class="card d-flex flex-column justify-content-center m-auto" style="width: 100%; height: 30vh; border: 0;">
                                    ...
                                    <div class="card-body position-relative">
                                        ...
                                        <a href="detailservice/{{$item->slug}}" class="btn btn-secondary disabled">Pesan</a>
                                        @else
                                        <p class="text-capitalize text-success position-absolute top-0 end-0" style="float: right;">{{$item->status}}</p>
                                        <a href="detailservice/{{$item->slug}}" class="btn btn-navy" >Pesan</a>
                                        @endif
                                    </div>
                                </div>
                            </div>
